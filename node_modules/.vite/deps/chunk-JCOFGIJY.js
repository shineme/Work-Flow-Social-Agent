...
function useKeyPress(keyFilter, options) {
  const actInsideInputWithModifier = toRef(() => toValue(options == null ? void 0 : options.actInsideInputWithModifier) ?? false);
  const target = toRef(() => toValue(options == null ? void 0 : options.target) ?? window);
...
//# sourceMappingURL=chunk-JCOFGIJY.js.map
